...
class BuyAmountScreenBody extends StatefulObserverWidget {
  const BuyAmountScreenBody({
    required this.asset,
    this.card,
    this.account,
  });
  ...
  @override
  State<BuyAmountScreenBody> createState() => _BuyAmountScreenBodyState();
}

class _BuyAmountScreenBodyState extends State<BuyAmountScreenBody>  with AutomaticKeepAliveClientMixin  {
  @override
