                      ...
                      children: [
                        ...
                        SNewActionPriceField(
                          ...
                          optionText: store.inputValue == '0' && store.isBothAssetsSeted
                              ? '''${intl.transfer_amount_transfer_all} ${getIt<AppStore>().isBalanceHide ? '**** EUR' : store.maxLimit.toFormatCount(symbol: 'EUR')}'''
                              : null,
                          optionOnTap: () {
                            store.onTransfetAll();
                          },
    ...
    return SuggestionButtonWidget(
      ...
      trailing: account == null && card == null
          ...
          : getIt<AppStore>().isBalanceHide
              ? '**** ${account?.currency}'
              : (account?.balance ?? card?.balance ?? Decimal.zero).toFormatCount(
                  accuracy: 2,
