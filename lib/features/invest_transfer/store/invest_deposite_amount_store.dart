...
part 'invest_deposite_amount_store.g.dart';

class InvestDepositeAmountStore extends _InvestDepositeAmountStoreBase with _$InvestDepositeAmountStore {
  InvestDepositeAmountStore() : super();

  static InvestDepositeAmountStore of(BuildContext context) =>
      Provider.of<InvestDepositeAmountStore>(context, listen: false);
}

abstract class _InvestDepositeAmountStoreBase with Store {
  _InvestDepositeAmountStoreBase() {
    loadConversionPrice(
      fiatSymbol,
      cryptoSymbol,
    );
