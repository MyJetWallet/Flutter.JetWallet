...
part 'invest_deposite_confirmation_store.g.dart';

class InvestDepositeConfirmationStore extends _InvestDepositeConfirmationStoreBase
    with _$InvestDepositeConfirmationStore {
  InvestDepositeConfirmationStore({
    required super.assetId,
    required super.amount,
  }) : super();

  static InvestDepositeConfirmationStore of(BuildContext context) =>
      Provider.of<InvestDepositeConfirmationStore>(context, listen: false);
}

abstract class _InvestDepositeConfirmationStoreBase with Store {
  _InvestDepositeConfirmationStoreBase({
  ...
  Future<void> confirm() async {
    try {
      ...
      final DC<ServerRejectException, dynamic> resp = await sNetwork.getWalletModule().postInvestDeposite(model);
      ...
      if (sRouter.currentPath != '/invest_deposite_confrimation') {
        return;
      }
