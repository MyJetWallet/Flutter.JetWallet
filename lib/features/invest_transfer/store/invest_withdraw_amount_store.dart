...
class InvestWithdrawAmountStore extends _InvestWithdrawAmountStoreBase with _$InvestWithdrawAmountStore {
  InvestWithdrawAmountStore() : super();

  static InvestWithdrawAmountStore of(BuildContext context) =>
      Provider.of<InvestWithdrawAmountStore>(context, listen: false);
}

abstract class _InvestWithdrawAmountStoreBase with Store {
  _InvestWithdrawAmountStoreBase() {
    loadConversionPrice(
      fiatSymbol,
      cryptoSymbol,
    );
  ...
  @computed
  bool get isShowTopUpModal => currency.isAssetBalanceEmpty;
  ...
  Decimal get maxLimit {
    return sSignalRModules.investWalletData?.balance ?? Decimal.zero;
  }
