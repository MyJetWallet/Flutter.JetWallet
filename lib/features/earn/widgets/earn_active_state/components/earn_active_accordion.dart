...
class EarnActiveAccordion extends StatelessObserverWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final filteredActiveOffers = earnOffers
        .where(
          (element) => element.amount > Decimal.zero,
        )
        .toList();
    final filteredAvailableOffers = earnOffers
        .where(
          (element) => element.amount == Decimal.zero,
        )
        .toList();
    ...
    */
    ...
    final actionIcon = isOpen ? const SAngleDownIcon() : const SAngleUpIcon();
                      ...
                      Padding(
                        ...
                        child: DecoratedBox(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              '${isActive ? filteredActiveOffers.length : listOfAssetsByEarns.length}',
