...
part 'earn_top_up_amount_store.g.dart';

class EarnTopUpAmountStore extends _EarnTopUpAmountStoreBase with _$EarnTopUpAmountStore {
  EarnTopUpAmountStore({required super.earnPosition}) : super();

  static EarnTopUpAmountStore of(BuildContext context) => Provider.of<EarnTopUpAmountStore>(context, listen: false);
}

abstract class _EarnTopUpAmountStoreBase with Store {
  _EarnTopUpAmountStoreBase({required this.earnPosition}) {
    loadConversionPrice(
      fiatSymbol,
      cryptoSymbol,
    );
