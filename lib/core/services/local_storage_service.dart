...
const walletIdsButtonsCheckedKey = 'walletIdsButtonsChecked';
...
class LocalStorageService {
  ...
  Future<void> clearStorage() async {
    ...
    final walletIdsChecked = await _storage.read(key: walletIdsButtonsCheckedKey);
    ...
    await _storage.write(key: walletIdsButtonsCheckedKey, value: walletIdsChecked);
  }
