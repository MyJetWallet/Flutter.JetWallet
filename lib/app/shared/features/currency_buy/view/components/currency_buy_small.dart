...
class CurrencyBuySmall extends StatefulHookWidget {
  const CurrencyBuySmall({
    Key? key,
  ...
  @override
  _CurrencyBuySmallState createState() => _CurrencyBuySmallState();
}

class _CurrencyBuySmallState extends State<CurrencyBuySmall> {
  @override
      ...
      child: Column(
        children: [
          ...
          SNumericKeyboardAmount(
            ...
            submitButtonActive:
                state.inputValid && !loader.value.value && !disableSubmit.value,
