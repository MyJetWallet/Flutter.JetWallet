...
class CurrencyBuyMedium extends StatefulHookWidget {
  const CurrencyBuyMedium({
    Key? key,
  ...
  @override
  _CurrencyBuyMediumState createState() => _CurrencyBuyMediumState();
}

class _CurrencyBuyMediumState extends State<CurrencyBuyMedium> {
  @override
