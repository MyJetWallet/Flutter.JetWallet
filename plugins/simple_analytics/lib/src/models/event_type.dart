...
class EventType {
  ...
  static const newBuyNoSavedCard = '‘Payment method - No Saved Cards’ screen view';
  static const newBuyTapAddCard = 'Tap on the ‘Add a Card’ button';
  static const newBuyTapCardContinue = 'Tap on the ‘Continue’ with Card Details button';
  static const newBuyBuyAssetView = '‘Buy Asset’ screen view';
  static const newBuyErrorLimit = 'Error - Buy Limit Exceeded';
  static const newBuyTapContinue = 'Tap on the button ‘Continue’ with Buy Asset';
  ...
  static const newBuyTapCloseProcessing = 'Tap on the button ‘Close’ Processing screen ';
  ...
  static const signInFlowOnboardingFirstScreenView = '‘Simple app for your finance’ screen view';
  static const signInFlowOnboardingSecondScreenView = "‘Don’t just buy crypto, earn it' screen view";
  static const signInFlowOnboardingThirdScreenView = '‘Trade 20+ Top Crypto assets’ screen view';
  static const signInFlowOnboardingFourScreenView = '‘Invite friends and earn more’ screen view';
  ...
  static const signInFlowTapToAgreeTCPP = 'Tap to agree to the T&C and Privacy Policy';
  static const signInFlowEmailContinue = 'Tap on button ‘Continue’ with email';
  static const signInFlowEmailVerificationView = '‘Email verification’ screen view';
  ...
  static const signInFlowTapRememberMyChoice = 'Tap on button ‘Remember my choice’ for email app';
  static const signInFlowTapResend = 'Tap on button ‘Resend’  verification code';
  static const signInFlowPleaseWait = '‘Please wait - Email Verification’  screen view';
  static const signInFlowErrorVerificationCode = 'Error - Wrong Email Verification Code';
  static const signInFlowPhoneNumberView = '‘Phone number’ screen view';
  static const signInFlowPhoneNumberContinue = 'Tap on the button ‘Continue’ with phone number';
  static const signInFlowPhoneConfirmView = '‘Phone confirmation’ screen view';
  static const signInFlowPhoneReceiveCodePhoneCall = 'Tap on the button ‘Receive code via phone call’';
  static const signInFlowPhoneConfirmWrongPhone = 'Error - Wrong Phone Confirmation Code';
  ...
  static const signInFlowPersonalContinue = 'Tap on button ‘Continue’ with name';
  static const signInFlowPersonalScreenViewLoading = "‘Loading - Personal details' screen view";
  static const signInFlowPersonalReferralLink = 'Tap on ‘I have referral code/link’ button';
  static const signInFlowPersonaReferralLinkScreenView = '‘Enter referral code/link’ screen view';
  static const signInFlowPersonaReferralLinkError = 'Error - ‘Invalid referral code/link’';
  static const signInFlowPersonaReferralLinkContinue = 'Tap on button ‘Continue’ with referral code/link';
  ...
  static const signInFlowEnableBiometricView = '‘Enable Face ID/biometrics to instantly login’ screen view';
  static const signInFlowEnableFaceID = 'Tap on button ‘Enable Face ID/biometrics’';
  static const signInFlowLaterFaceID = 'Tap on button ‘Later’ with enabling Face ID/biometrics';
  static const signInFlowFaceIDScreenView = '‘Allow Simple to use Face ID/ biometrics’ screen view';
  static const signInFlowFaceAllowFaceID = 'Tap on button ‘Allow’ to use Face ID/biometrics';
  static const signInFlowFaceDontAllowFaceID = 'Tap on button ‘Don’t Allow’ to use Face ID/biometrics';
  static const verificationProfileScreenView = "'Verification your profile' screen view";
  static const verificationProfileLogout = "Tap on button 'Logout' on screen 'Verification your profile'";
  static const verificationProfileProvideInfo =
      '''Tap on button 'Provide Information' on screen `Verification your profile`''';
  static const verificationProfileCreatePIN = "Tap on button 'Create PIN' on screen 'Verification your profile'";
  static const signInFlowEnterPinView = '‘Enter your PIN code’ screen view';
  static const signInFlowVerificationPassed = '‘Verification passed’(Portfolio) screen view';
  static const paymentCurrencyPopupScreenView = '‘Payment currency’popup screen view';
  static const paymentMethodScreenView = '‘Payment methods’ screen view';
  static const paymentWevViewScreenView = '‘Payment web view’ screen view';
  static const paymentWevViewClose = 'Tap on the button ‘Close’ on Payment web view';
  static const tapOnTheReceiveButton = 'Tap on the ‘Receive’ button';
  static const chooseAssetToReceiveScreenView = '‘Choose asset to receive’ screen view';
  ...
  static const tapOnTheButtonNetworkOnReceiveAssetScreen = "Tap on the button ‘Network’ on 'Receive Asset' screen";
  static const chooseNetworkPopupViewShowedOnReceiveAssetScreen =
      "‘Choose Network’ popup view showed on 'Receive Asset' screen";
  static const tapOnTheButtonCopyOnReceiveAssetScreen = "Tap on the button ‘Copy’ on 'Receive Asset' screen";
  static const tapOnTheButtonShareOnReceiveAssetScreen = "Tap on the button ‘Share’ on 'Receive Asset' screen";

  // KYC

  static const kycFlowVerificationScreenView = '‘Verification your profile’ screen view';
  ...
  static const kycFlowCoutryOfIssueShow = "Tap on the button ‘Country of Issue’ on 'Verify your identity' screen";
  static const kycFlowCoutryOfIssueSheetView = '‘Country of Issue’ sheet view ';
  static const kycFlowCoutryOfIssueCont = "Tap on the button ‘Country of Issue’ on 'Verify your identity' screen";
  static const kycFlowVerifyWait = "‘Please wait - Verify your identity' screen view";
  static const kycFlowSumsubShow = '‘Sumsub kyc webview’ screen view';
  static const kycFlowSumsubClose = "Tap on the button ‘Close’ on 'Sumsub kyc webview' screen";
  ...
  static const kycFlowYouBlockedSupportTap = "Tap on the button ‘Support’ on 'You’re blocked!' popup";
  ...
  static const tapOnTheContWithReceiverDetailsButton = "Tap on the ‘Continue’ with Receiver's Details button";

  // Iban send
  static const accountTabScreenView = "'Account tab' screen view";
  static const tapOnTheButtonAddBankAccount = 'Tap on the button ‘Add bank account’';
  static const tapOnTheButtonAddAccount = 'Tap on the button ‘Add account’';
  static const tapOnTheButtonWithAnyExistAccount = 'Tap on the  button with any exist account';
  static const sendEurAmountScreenView = "'Send EUR amount' screen view";
  static const tapOnTheButtonLimitsIBAN = 'Tap on the button ‘Limits IBAN send’';
  ...
  static const tapOnTheButtonContSendIbanAmount = 'Tap on the button ‘Continue’ with ‘Send IBAN Amount’ screen';
  static const orderSummarySendIBANScreenView = "Order summary Send IBAN' screen view";
  static const tapOnTheButtonConfirmSendIban = 'Tap on the button ‘Confirm’ Order Summary Send IBAN';
  ...
  static const chooseAssetToSendScreenView = '‘Choose asset to send’ screen view';
  static const destinationCountryScreenView = '‘Destination country’ screen view';
  ...
  static const globalSendContinueReceiveDetail = "Tap on the button ‘Continue’ with ‘Receiver's details’ screen";
  static const globalSendAmountScreenView = '‘Send Globally’ amount screen view';
  ...
  static const globalSendContinueAmountSc = 'Tap on the button ‘Continue’ with ‘Send Globally Amount’ screen';
  static const globalSendOrderSV = "Order summary Send Globally' screen view";
  static const globalSendConfirmOrderSummary = 'Tap on the button ‘Confirm’ Order Summary Send Globally';
  ...
  static const cryptoSendChooseAssetScreenView = '‘Choose asset to send’ screen view';
  static const cryptoSendSendAssetNameScreenView = '‘Send #Assetname’ screen view';
  static const cryptoSendChooseNetworkScreenView = '‘Choose Network’ sheet view';
  ...
  static const cryptoSendAssetNameAmountScreenView = '‘Send #AssetName’ amount screen view';
  static const cryptoSendErrorLimit = 'Error - Send Limit Exceeded ';
  static const cryptoSendTapContinueAmountScreen = 'Tap on the button ‘Continue’ with ‘Send #assetName Amount’ screen';
  static const cryptoSendOrderSummarySend = "Order summary Send' screen view";
  static const cryptoSendTapConfirmOrder = 'Tap on the button ‘Confirm’ Order Summary Send';
  static const cryptoSendLoadingOrderSummary = "‘Loading - Order Summary' screen view";
  static const cryptoSendBioApprove = "‘FaceID/TouchID/PIN approve' screen view";
  static const cryptoSendFailedSend = '‘Failed Send’ screen view';
  static const cryptoSendSuccessSend = '‘Success Send’ screen view';
  static const receiverSDetailsScreenView = "`Receiver's details` screen view";
  static const tapOnTheContinueWithReceiverSDetailsButton = "Tap on the ‘Continue’ with Receiver's Details button";
  ...
  static const tapOnTheButtonConfirmOrderSummarySend = 'Tap on the button ‘Confirm’ Order Summary Send';
  ...
  static const tapOnTheButtonShareOnShareSheet = 'Tap on the button ‘Share’ on share sheet';
  static const tapOnTheButtonCopyOnShareSheet = 'Tap on the button ‘Copy’ on share sheet';
  ...
  static const tapOnTheButtonClaimOnClaimGiftSheet = 'Tap on the button ‘Claim’ on Claim Gift sheet';
  ...
  static const tapOnTheButtonRejectOnClaimGiftSheet = 'Tap on the button ‘Reject’ on Claim Gift sheet';
  static const cancelClaimTransactionGiftScreenView = '`Cancel claim transaction gift` screen view';
  ...
  static const processingClaimGiftScreenView = '`Processing claim gift` screen view';
  static const failedClaimGiftScreenView = '`Failed claim gift` screen view';
  static const tapOnTheButtonCloseOnFailedClaimGiftScreen = 'Tap on the button ‘Close’ on Failed claim gift screen';
  static const successClaimedGiftScreenView = '`Success claimed gift` screen view';
